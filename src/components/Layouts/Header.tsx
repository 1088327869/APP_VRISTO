...
const Header = () => {
    ...
    // Inicializar el estado del formulario con valores predeterminados
    ...
    const [messages, setMessages] = useState([
        {
            ...
            title: 'Bienvenido a Solucredito',
            message: 'Disfruta de nuestra nueva aplicación de Solucredito. Recuerda que estamos aquí para atenderte y servirte.',
            time: '1hr',
        },
    ]);
    ...
    const [notifications, setNotifications] = useState([
        {
            ...
            message: 'Ni idea de que es esto',
            time: '45 min ago',
        },
        {
            id: 2,
                ...
                <div className="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-black">
                    <div className="horizontal-logo flex lg:hidden justify-between items-center ltr:mr-2 rtl:ml-2">
                        <Link to="/" className="main-logo flex items-center shrink-0">
                            ...
                            <span className="text-2xl ltr:ml-1.5 rtl:mr-1.5  font-semibold  align-middle hidden md:inline dark:text-white-light transition-all duration-300">SOLU</span>
                        </Link>
                        <button
                            type="button"
                            ...
                            <Dropdown
                                ...
                                button={
                                    <img
                                        ...
                                        src={formData.foto ? formData.foto : '/assets/images/clients/user.png'}
                                        alt="userProfile"
                                    />
                                }
                            >
                                <ul className="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    <li>
                                        <div className="flex items-center px-4 py-4">
                                            <img className="rounded-md w-10 h-10 object-cover" src={formData.foto ? formData.foto : '/assets/images/clients/user.png'} alt="userProfile" />
                                    ...
                                    <li>
                                        <Link to="/forms/wizards/actualizar" className="dark:hover:text-white">
                                    ...
                                    <li>
                                        <Link to="/recup/new/password" className="dark:hover:text-white">
