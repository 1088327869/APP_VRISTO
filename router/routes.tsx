...
const EstudiosCredito = lazy(() => import('../pages/Users/estudioCredito'));
...
const RecoverIdBoxed = lazy(() => import('../pages/Authentication/login/RecoverIdBox'));
const LoginCover = lazy(() => import('../pages/Authentication/LoginCover'));
const RegisterCover = lazy(() => import('../pages/Authentication/login/RegisterCover'));
...
const Wizards = lazy(() => import('../pages/Forms/RegistroCliente/Wizards'));
const FormularioActualizar = lazy(() => import('../pages/Forms/RegistroActualizar/Wizards'));
...
const routes = [
  ...
  //  registro de  confirmacion de mensaje de texto
  {
    path: '/msm',
    element: <ConfirmarMsm />,
    layout: 'blank',
  },
  {
  ...
  {
    path: '/forms/wizards/actualizar',
    element: <FormularioActualizar />,
  },
  // {
